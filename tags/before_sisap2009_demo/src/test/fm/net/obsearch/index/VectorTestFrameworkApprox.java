...
<#list types as t>
<@type_info t=t/>
<@pp.changeOutputFile name="VectorTestFrameworkApprox${Type}.java" />
...
public class VectorTestFrameworkApprox${Type} extends TestFrameworkApprox${Type}<OBVector${Type}> {

	private int vectorDimensionality;
	private Random r;
	public VectorTestFrameworkApprox${Type}(int vectorDimensionality, int dbSize, int querySize,
