...
public abstract class AbstractDistPermPrefix <O extends OB, B extends BucketObject<O>, Q, BC extends BucketContainer<O, B, Q>>extends
	AbstractBucketSorter<O, B, Q, BC, PermPrefixProjection, CompactPermPrefix> {

		static final transient Logger logger = Logger
		.getLogger(AbstractDistPermPrefix.class.getName());
