package net.obsearch.index.permprefixhamming.impl;
...
import net.obsearch.index.permprefixhamming.CompactPermPrefix;
import net.obsearch.index.permprefixhamming.PermPrefixProjection;
import net.obsearch.index.permprefixhamming.AbstractDistPermPrefixHamming;

public class DistPermPrefixHammingFloat<O extends OBFloat> extends AbstractDistPermPrefixHamming<O, BucketObjectFloat<O>, OBQueryFloat<O>, SleekBucketFloat<O>> implements IndexFloat<O> {

	
	static final transient Logger logger = Logger
	.getLogger(DistPermPrefixHammingFloat.class.getName());
	
	public DistPermPrefixHammingFloat(Class<O> type,
