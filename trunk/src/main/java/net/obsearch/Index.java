...
public interface Index < O extends OB > {
    ...
    /**
     * Inserts the given object into the index. If the object is already in the
     * DB, the multiplicity count is incremented by one.
     *  * <b>If this method is called before calling {@link #insert(OB, long)} , then 
     * all the future insertions must be done through this method. </b>
     * @param object
     ...
     * Inserts the given object into the index. If the object is already in the
     * DB, the multiplicity count is incremented by one.
     * <b>If this method is called before calling {@link #insert(OB)}, then 
     * all the future insertions must be done through this method. </b>
     * @param object
     *                The object to be added Identification number of the given
     *                object. This number must be responsibly generated by
    ...
    /**
     * Helper method used to force the mode of an index to 
     * auto id generation or user-given id. 
     * The method can only be called if the index is empty.
     * @param auto true == set id auto generation, false == user given id generation.
     */
    void setIdAutoGeneration(boolean auto)throws OBException ;
