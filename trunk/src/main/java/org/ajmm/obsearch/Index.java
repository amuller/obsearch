...
public interface Index {
    /**
       ...
       @param k The maximum number of objects to be returned
			 ...
			 @since 0.0
     */
		public void searchID(OB object, byte k, DimensionHandler r, Result[] result);
       ...
       @param k The maximum number of objects to be returned
			 ...
			 @since 0.0
     */
	  public void searchOB(OB object, byte k, DimensionHandler r, OBResult[] result);
		...
		/**
		  ...
		  @param object The object to be added
			...
			@since 0.0
		 */ 
		 //TODO: make sure that the community is ok with storing 2,147,483,647 objects
		 // the IDs must be provided because the ID control has to be centralized
		public byte insert(OB object, int ID) throws IllegalIDException;
