...
public interface Index < O extends OB > {
     ...
     *         {@link org.ajmm.obsearch.Result.Status#EXISTS} then the result will hold
     ...
     * @return {@link org.ajmm.obsearch.Result.Status#EXISTS} and the object's id if
     ...
     * @return {@link org.ajmm.obsearch.Result.Status#OK} and the deleted object's id
     *         if the object was found and successfully deleted.
     *         {@link org.ajmm.obsearch.Result.Status#NOT_EXISTS} if the object is not
     *         in the database.
