...
public class FixedPivotSelector implements PivotSelector {
   ...
   /*   int[] pivotArray =
    ...
    // kmeans++ selected.      (we were using this one before!)
     //int[] pivotArray = {163061, 110606, 56344, 238657, 344941, 104868, 52473, 306248, 93852, 34913, 38839, 104441, 32621, 267878, 225436, 51165, 195261, 305531, 116084, 232130, 241638, 73961, 255471, 281809, 261511, 238568, 204115, 5642, 193213, 274868};
     
    
     // navarro with better settings
     // validate selected pivots. MTD 16 pivots
     //int [] pivotArray = {173221, 81425, 258192, 229333, 256964, 187123, 211523, 143917, 28954, 262061, 86748, 218554, 113214, 260088, 337932, 11769};

    // 30 pivots for TED!!! :)
    //int [] pivotArray = {57300, 196436, 10653, 136029, 203654, 189753, 152060, 133273, 236109, 144716, 30129, 192050, 14036, 28810, 202543, 59154, 123211, 203986, 5279, 118146, 75130, 135862, 200942, 92282, 77436, 110657, 116055, 37261, 94338, 235642};
    
    // 32 pivots for TED
    
    //int [] pivotArray = {68837, 223235, 57634, 34056, 157833, 82856, 129010, 95903, 155337, 53284, 25306, 50538, 84025, 13301, 190506, 210276, 206931, 27289, 6508, 176723, 84614, 192319, 63271, 238035, 34453, 94959, 131639, 110443, 113794, 133047, 224166, 132884};
    
    // 20 pivots for LEV
    //int [] pivotArray = {467023, 264003, 474731, 363298, 280463, 659272, 796706, 112242, 175608, 545550, 520555, 578161, 83328, 850889, 163530, 438778, 389451, 167736, 454957, 725722};
    
    // 30 pivots for LEV
    //int [] pivotArray = {496827, 443276, 203657, 596825, 502345, 540033, 829573, 324825, 202637, 731792, 938727, 157919, 237726, 755572, 468412, 987674, 783351, 606873, 917533, 633898, 358242, 514174, 75537, 460217, 196829, 85855, 453600, 475013, 410323, 660634};
    
    int[] pivotArray = {531932, 685539, 145883, 499259, 333270, 559680, 433475, 199632, 207223, 104251, 371736, 849699, 318647, 984489, 859535, 671058, 363970, 956981, 513334, 964223, 334772, 506545, 790850, 505773, 929391, 473585, 472635, 116958, 80913, 54993, 392780, 838883, 826788, 649132, 273529, 53507, 301876, 779111, 845644, 166531, 187315, 354550, 516426, 866794, 53854, 135413, 108076, 290192, 833345, 102436, 403784, 465131, 910560, 493666, 902692, 463641, 524718, 768379, 632353, 453069};
