...
public class FixedPivotSelector implements PivotSelector {
    ...
    // 438778, 389451, 167736, 454957, 725722};
     ...
     int [] pivotArray = {700067, 876881, 148534, 481671, 331775, 15967, 91979, 155992, 495765, 546877, 834266};
     
     
    // 60 pivots for LEV (normal exp)
     /*
    int[] pivotArray = { 52667, 992478, 365508, 197290, 65310, 863770, 362621,
     ...
     // 30 pivots for LEV-scalab
    
     //int[] pivotArray = {94323, 63655, 37558, 34472, 54433, 88958, 97696, 88615, 93960, 93739, 97697, 20414, 34162, 21023, 66357, 65775, 74077, 74498, 69404, 75965, 31607, 55316, 91240, 326, 10456, 41388, 64728, 39269, 63582, 54810};
