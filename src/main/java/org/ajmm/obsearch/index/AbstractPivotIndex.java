...
public abstract class AbstractPivotIndex<O extends OB> implements Index<O> {
    ...
    /**
         ...
         * @param pivotSelector
         *                The object that will choose a hopefully good set of
         *                pivots from the DB.
         * @param type
         *                The type of the object the user will use. Has to match
         *                with O. Do something like YourObj.class
    ...
    /**
         * Creates an array with the pivots It has to be created like this
    ...
    /**
         * Initialization of all the databases involved Subclasses should
         * override this method if they want to create new databases
         * 
         * @throws DatabaseException
         */
    ...
    /**
         * This method is called by xstream when all the serialized fields have
         * been populated
         * 
         * @return
         * @throws DatabaseException
    ...
    /**
         * Class used to create the key that will be used to index the objects
         * by time
         */
    ...
    /**
         ...
         * same settings. TODO: Need to tweak these values
         * 
         * @throws DatabaseException
    ...
    /**
         * Inserts in database A the given Object. The timestamp of the object
         * is stored too.
         * 
         * @param object
         * @param id
    ...
    /**
         * Utility method to insert data in C after freezing. Must be
         * implemented by the subclasses It should not insert anything into A
         * 
         * @param object
         *                The object to be inserted
         * @param id
    ...
    /**
         ...
         * should call this method before calling freeze. Users do not have to
    ...
    /**
         ...
         * while it is a good idea to rebuild de index. After the method
         * returns, searching is enabled.
         * 
         * @param pivotSelector
         ...
         *                 If the index was already frozen and the user
         *                 attempted to freeze it again
         */
    ...
    /*
         ...
         * InstantiationException, DatabaseException, OBException { Cursor
         * cursor = null; DatabaseEntry foundKey = new DatabaseEntry();
         * DatabaseEntry foundData = new DatabaseEntry(); try { int i = 0;
         * 
         * cursor = aDB.openCursor(null, null); O obj =
         * this.instantiateObject(); while (cursor.getNext(foundKey, foundData,
         * LockMode.DEFAULT) == OperationStatus.SUCCESS) { int id =
         * IntegerBinding.entryToInt(foundKey); assert i == id; TupleInput in =
         * new TupleInput(foundData.getData()); obj.load(in); insertFrozen(obj,
         * id); i++; } // should be the same } finally { cursor.close(); } }
         */
    ...
    /**
         * Inserts the given tuple in the database B using the given id B
         * database will hold tuples of floats (they have been normalized)
         * 
         * @param id
    ...
    /*
         ...
         * assert tuple.length == pivotsCount; // first encode all the
         * dimensions in an array while (i < tuple.length) {
         * tuple[i].store(out); // stores the given pivot i++; } // now we can
         * store it in the database DatabaseEntry keyEntry = new
         * DatabaseEntry(); IntegerBinding.intToEntry(id, keyEntry);
    ...
    /*
         ...
         * OBException { assert tuple.length == this.pivotsCount; int i = 0;
         * while (i < tuple.length) { obj.distance(this.pivots[i], tuple[i]);
         * i++; } }
         */
    ...
    /**
         * Generates the name of the file to be used to store the serialized
    ...
    /**
         ...
         * @param DB
         *                the database to be accessed the object will be
         *                returned here
