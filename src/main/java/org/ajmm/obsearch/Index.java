 ...
 * sample data is distributed to improve performance You cannot perform searches
 * on an unfrozen index. Note that freezing the index does not mean you can't
 * insert new data. You can! 3) Insert/Delete new records/ and search! yay!
 * There are indexes that wrap other indexes to provide extended functionality.
 * These indexes might not need to be frozen. Please consult the documentation
 * for each index.
 * 
 * @param <O>
