 ...
 * @param <N>
 */
public abstract class AbstractIncrementalRF02<O extends OB> extends
		AbstractIncrementalPivotSelector<O> implements
		IncrementalPairPivotSelector<O> {

	private static final transient Logger logger = Logger
			.getLogger(AbstractIncrementalRF02.class.getName());
	...
	protected class Score {
		...
		public String toString() {
			return "Spread: " + spread + " dist: " + distortion + " dH: "
		...
		public boolean isValid() {
			return spread >= desiredSpread && distortion <= desiredDistortion;
		}
