package net.obsearch.ambient.l;
...
public class AmbientL<O extends OB,  I extends Index<O>> extends AbstractAmbient<O, I>{

    /**
     * @see net.obsearch.result.ambient.AbstractAmbient#AbstractAmbient(I index, File directory)
     */
    public AmbientL(I index, File directory) throws FileNotFoundException, OBStorageException,
     ...
     */
    public AmbientL(File directory) throws FileNotFoundException, OBStorageException,
    NotFrozenException, IllegalAccessException, InstantiationException,
    OBException, IOException{
        super(directory);
    }
     ...
     */
    @Override
    protected OBLFactory createFactory(File factoryDirectory) throws OBStorageException{        
        OBLFactory fact = null;
        try{
            fact = new OBLFactory(factoryDirectory);
        }catch(Exception e){
