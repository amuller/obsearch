...
import net.obsearch.index.ky0.Ky0Float;
...
public class VectorsDemoKy0 extends AbstractGHSExample {
	
	final static Random r = new Random();
	
	final static int VEC_SIZE = 10;

	public VectorsDemoKy0 (String[] args) throws IOException,
	...
	protected void create() throws FileNotFoundException, OBStorageException,
		...
		Ky0Float<OBVectorFloat> index = new Ky0Float<OBVectorFloat>(
				OBVectorFloat.class, sel, 5000, 0);
		// amplify the result of some perms.
		
		// number of heights
		// number of objects accessed per kHeight for the last guy.
		...
		// Sketch64Short<L1>>( index, INDEX_FOLDER );
		Ambient<OBVectorFloat, Ky0Float<OBVectorFloat>> a = new AmbientTC<OBVectorFloat, Ky0Float<OBVectorFloat>>(
				index, indexFolder);
	...
	protected void search() throws FileNotFoundException, OBStorageException,
		...
		Ambient<OBVectorFloat, Ky0Float<OBVectorFloat>> a =  new AmbientTC<OBVectorFloat, Ky0Float<OBVectorFloat>>(super.indexFolder);
		Ky0Float<OBVectorFloat> index = a.getIndex();
	...
	PivotsUnavailableException {
		...
		VectorsDemoKy0 s = new VectorsDemoKy0(args);
